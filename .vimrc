set foldmethod=marker "{{{stuff to be folded"}}}
"These are folds. _zo_ opens _zc_ closes
"{{{Vundle
...
"
"The following line is how I designate a file bookmark.
"It was recorded by pressing _mV_
"//V;;V;;V;;V;;V;;V;;V;;V;;V;;V;;V;;V;;V;; <-- Press _'V_
"(It is accessible from anywhere within your file heirarchy!j


"nnoremap <Leader>m :Cmapkeys<CR>
"set backspace=2
""fast exits!
...
""stuff from tpope's pathogen solarized
"syntax enable
""set background=dark
...
""display working buffer at bottom
""set laststatus=1
""set statusline+=%F
...
""my add-on for discarding buffer in current window:
"nnoremap <Leader>d :bdelete<CR>

""make search highlights less painfull on the eyes
""hi Search cterm=NONE ctermfg=grey ctermbg=blue

""press comma then n to turn off highlights
"nnoremap <Leader>n :nohl<CR>

""access window commands with {,w}
"nnoremap <Leader>w <c-w>

"set hidden "you may now shoot yourself in the foot by changing buffers without writing
...
"set ignorecase "case aint no thang for searching

""Highlight the current line
"set cursorline
"hi CursorLine cterm=bold guibg=Grey40
"anywhere you see the pattern on the following line \
"you may type 'V to visit the line of that file FROM ANYWHERE (powerfull shit)
